...
const PLAN = {
  ...
  score_labels: {
    face_oiliness:    ["", "基本不油", "轻微", "正常", "明显", "非常油"],
    scalp_oiliness:   ["", "基本不油", "轻微", "正常", "明显", "非常油"],
    hair_shedding:    ["", "明显减少", "较少", "正常", "较多", "非常明显"],
    dry_mouth:        ["", "没有", "轻微", "一般", "明显", "严重"],
    scrotal_moisture: ["", "基本干燥", "偶尔潮湿", "轻微潮湿", "明显潮湿", "经常非常湿"],
    sleep_quality:    ["", "很差", "较差", "一般", "较好", "很好"],
    energy_level:     ["", "极度疲惫", "疲倦", "一般", "精力充沛", "非常好"],
